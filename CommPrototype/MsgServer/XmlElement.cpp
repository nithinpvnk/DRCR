...
int main()
{
  ...
  name1->addChild(makeTextElement("File1.h"));
  
  sPtr name2 = makeTaggedElement("name");
  mtdata->addChild(name2);
  name2->addChild(makeTextElement("File1.cpp"));
  ...
  deps->addChild(dep1);
  dep1->addChild(makeTextElement("File2.h"));

  sPtr dep2 = makeTaggedElement("dep");
  deps->addChild(dep2);
  dep2->addChild(makeTextElement("File3.cpp"));
